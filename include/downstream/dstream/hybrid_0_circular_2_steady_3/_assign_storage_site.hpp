#pragma once
#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_CIRCULAR_2_STEADY_3__ASSIGN_STORAGE_SITE_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_CIRCULAR_2_STEADY_3__ASSIGN_STORAGE_SITE_HPP
...
namespace dstream_hybrid_0_circular_2_steady_3 {
...
UINT _assign_storage_site(const UINT S, const UINT T) {
  assert(dstream_hybrid_0_circular_2_steady_3::has_ingest_capacity<UINT>(S, T));
...
std::optional<UINT> assign_storage_site(const UINT S, const UINT T) {
  const UINT site =
      dstream_hybrid_0_circular_2_steady_3::_assign_storage_site<UINT>(S, T);
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_CIRCULAR_2_STEADY_3__ASSIGN_STORAGE_SITE_HPP
