#pragma once
#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_CIRCULAR_5_STEADY_6__ASSIGN_STORAGE_SITE_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_CIRCULAR_5_STEADY_6__ASSIGN_STORAGE_SITE_HPP
...
std::optional<UINT> assign_storage_site(const UINT S, const UINT T) {
  const UINT site =
      dstream_hybrid_0_circular_5_steady_6::_assign_storage_site<UINT>(S, T);
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_CIRCULAR_5_STEADY_6__ASSIGN_STORAGE_SITE_HPP
