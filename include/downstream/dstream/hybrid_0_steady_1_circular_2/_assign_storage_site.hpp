#pragma once
#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_CIRCULAR_2__ASSIGN_STORAGE_SITE_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_CIRCULAR_2__ASSIGN_STORAGE_SITE_HPP
...
namespace dstream_hybrid_0_steady_1_circular_2 {

/**
 * Internal implementation of site selection for hybrid steady/circular curation.
 *
...
UINT _assign_storage_site(const UINT S, const UINT T) {
  assert(dstream_hybrid_0_steady_1_circular_2::has_ingest_capacity<UINT>(S, T));
...
std::optional<UINT> assign_storage_site(const UINT S, const UINT T) {
  const UINT site =
      dstream_hybrid_0_steady_1_circular_2::_assign_storage_site<UINT>(S, T);
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_CIRCULAR_2__ASSIGN_STORAGE_SITE_HPP
