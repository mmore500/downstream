#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_STRETCHED_2_ALGO_HYBRID_ASSIGN_STORAGE_SITE_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_STRETCHED_2_ALGO_HYBRID_ASSIGN_STORAGE_SITE_HPP
...
#include "../stretched_algo/_stretched_assign_storage_site.hpp"
...
const uint64_t _hybrid_assign_storage_site(const uint64_t S, const uint64_t T) {
  ...
  if ((T & 1) == 0) {
    ...
    return half_S +
           stretched_algo::_stretched_assign_storage_site(half_S, half_T);
  }
}
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_STRETCHED_2_ALGO_HYBRID_ASSIGN_STORAGE_SITE_HPP
