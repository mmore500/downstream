#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_TILTED_2_ALGO_HYBRID_HAS_INGEST_CAPACITY_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_TILTED_2_ALGO_HYBRID_HAS_INGEST_CAPACITY_HPP
...
#include "../tilted_algo/_tilted_has_ingest_capacity.hpp"
...
const bool hybrid_has_ingest_capacity(const uint64_t S, const uint64_t T) {
  ...
  const bool has_capacity_2nd =
      ((T == 0) or
       tilted_algo::tilted_has_ingest_capacity(half_S, (T - 1) >> 1));
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_1_TILTED_2_ALGO_HYBRID_HAS_INGEST_CAPACITY_HPP
