#pragma once
#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_2_TILTED_3__ASSIGN_STORAGE_SITE_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_2_TILTED_3__ASSIGN_STORAGE_SITE_HPP
...
namespace dstream_hybrid_0_steady_2_tilted_3 {

/**
 * Internal implementation of site selection for hybrid steady/tilted
 * curation.
 *
...
std::optional<UINT> assign_storage_site(const UINT S, const UINT T) {
  const UINT site =
      dstream_hybrid_0_steady_2_tilted_3::_assign_storage_site<UINT>(S, T);
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_STEADY_2_TILTED_3__ASSIGN_STORAGE_SITE_HPP
