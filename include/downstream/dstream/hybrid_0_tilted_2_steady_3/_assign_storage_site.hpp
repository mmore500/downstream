#pragma once
#ifndef DOWNSTREAM_DSTREAM_HYBRID_0_TILTED_2_STEADY_3__ASSIGN_STORAGE_SITE_HPP
#define DOWNSTREAM_DSTREAM_HYBRID_0_TILTED_2_STEADY_3__ASSIGN_STORAGE_SITE_HPP
...
/**
 * Internal implementation of site selection for hybrid tilted/steady
 * curation.
 *
...
UINT _assign_storage_site(const UINT S, const UINT T) {
  assert(dstream_hybrid_0_tilted_2_steady_3::has_ingest_capacity<UINT>(S, T));
...
/**
 * Site selection algorithm for hybrid tilted/steady curation.
 *
 * @tparam UINT Unsigned integer type for operands and return value.
 * @param S Buffer size.
...
std::optional<UINT> assign_storage_site(const UINT S, const UINT T) {
  const UINT site =
      dstream_hybrid_0_tilted_2_steady_3::_assign_storage_site<UINT>(S, T);
...
#endif  // DOWNSTREAM_DSTREAM_HYBRID_0_TILTED_2_STEADY_3__ASSIGN_STORAGE_SITE_HPP
