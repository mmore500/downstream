#ifndef DOWNSTREAM_DSTREAM_STRETCHED_HAS_INGEST_CAPACITY_HPP
#define DOWNSTREAM_DSTREAM_STRETCHED_HAS_INGEST_CAPACITY_HPP
...
#endif  // DOWNSTREAM_DSTREAM_STRETCHED_HAS_INGEST_CAPACITY_HPP
